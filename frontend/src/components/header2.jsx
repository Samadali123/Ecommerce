...
const Header2 = () => {
    ...
    return (
        <header className="bg-gradient-to-r w-full from-blue-500   to-purple-500 pt-4 px-4 py-12 h-[8vh]">
            ...
            {/* <FaArrowLeft onClick={backtohome} className="text-white mx-2 mt-2 hover:text-gray-700 cursor-pointer mr-2" size={24} /> */}
                    <div onClick={handleDivClick} className="text-white  cursor-pointer text-2xl md:text-2xl lg:xl font-bold ml-2">
                        My Shopee
                    </div>
                
                </div>
                <button className="text-white md:hidden pt-2" onClick={toggleSidebar}>
                <CiSearch size={26} />
                    </button>
